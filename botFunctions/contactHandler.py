    ...
    if(message.from_user.id == admin and message.reply_to_message != None):
        try:
            if (message.contact.last_name != None):
                bot.send_contact(chat_id=message.reply_to_message.forward_from.id, phone_number=message.contact.phone_number, first_name=message.contact.first_name, last_name=message.contact.last_name)
            else:
                bot.send_contact(chat_id=message.reply_to_message.forward_from.id, phone_number=message.contact.phone_number, first_name=message.contact.first_name)
        except:
